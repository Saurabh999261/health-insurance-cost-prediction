...
- Encoded categorical variables using Label Encoding: Gender, Smoking Status, Region
...
- KNN produced lower performance as distance-based algorithms are highly sensitive to feature scaling — applying StandardScaler could improve its results in future iterations.
